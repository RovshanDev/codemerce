        ...
        <div id="content" class="col-sm-12">
            ...
            <div class="table-responsive form-group">
                <table class="table table-bordered">
                    ...
                    <tbody>
                    <tr>
                        <td class="text-center"><a href="<?=base_url('frontend/product')?>"><img width="70px" src="<?=base_url()?>assets/frontend/image/demo/shop/product/E3.jpg" alt="Aspire Ultrabook Laptop" title="Aspire Ultrabook Laptop" class="img-thumbnail" /></a></td>
                        <td class="text-left"><a href="<?=base_url('frontend/product')?>">Aspire Ultrabook Laptop</a><br />
                    ...
                    <tr>
                        <td class="text-center"><a href="<?=base_url('frontend/product')?>"><img width="70px" src="<?=base_url()?>assets/frontend/image/demo/shop/product/E1.jpg" alt="Xitefun Causal Wear Fancy Shoes" title="Xitefun Causal Wear Fancy Shoes" class="img-thumbnail" /></a></td>
                        <td class="text-left"><a href="<?=base_url('frontend/product')?>">Xitefun Causal Wear Fancy Shoes</a></td>
