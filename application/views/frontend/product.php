                    ...
                    <div class="row">
                        <div class="content-product-left  col-sm-6 col-xs-12 ">
                            ...
                            <div class="large-image  vertical">
                                <img itemprop="image" class="product-image-zoom" src="<?=base_url('uploads/').$item->path?>" data-zoom-image="<?=base_url('uploads/').$item->path?>" title="<?=$list->title?>" alt="<?=$list->title?>">
                            </div>
                        ...
                        <div class="content-product-right col-sm-6 col-xs-12">
                            ...
                            <div class="product-label form-group">
                                ...
                                <div class="product_page_price price" itemprop="offerDetails" itemscope="" itemtype="http://data-vocabulary.org/Offer">
                                    <span class="price-new" itemprop="price"><?=$list->price?></span>
